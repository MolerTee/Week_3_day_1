...
SELECT name FROM people WHERE name = 'Steven Noble';
DELETE FROM movies WHERE title = 'Batman Begins';
INSERT INTO people (name) VALUES ('Rick');
DELETE FROM people WHERE name = 'Craig Morton';
UPDATE people SET name = 'Andy Lonsdale' WHERE name = 'Andrew Lonsdale';
INSERT INTO movies (title , year , show_time) VALUES ('Guardians of the Galaxy 2' , 2016 , '22:00');
UPDATE movies SET show_time = '12:10 to 21:30' where title = 'Guardians of the Galaxy 2';
